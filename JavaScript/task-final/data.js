...
const categoryButtons = document.querySelectorAll('.left-side-tags button');
  ...
  button.addEventListener('click', () => {
    ...
    const filteredFeedback = feedbackData.filter(feedback => {
      if (selectedCategory === 'all') {
        ...
        return feedback.status === 'suggestion' && feedback.category === selectedCategory;
      }
    });

    filteredFeedback.filter(feedback => feedback.status === 'suggestion').forEach(feedback => {
